...
from database import  engine  # Import the sessionmaker
from sqlalchemy.orm import sessionmaker

def create_sample_users():
    # Create a session instance
    # session = SessionLocal()  # Now session is an actual session object
    ...
    try:
        ...
        # Now create second-level users, linking them to first-level users
        ...
        # Add second-level users to the session and commit
